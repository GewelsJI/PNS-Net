...
##data
parser.add_argument('--data_statistics', type=str, default="dataset/statistics.pth")
parser.add_argument('--img_dataset_list', type=str, default=["IVPS-TrainSet"])
parser.add_argument('--video_dataset_list', type=str, default=["ASU-Mayo_Clinic", "CVC-ClinicDB-612", "CVC-ColonDB-300"])
parser.add_argument('--img_dataset_root', type=str,default="dataset/")
parser.add_argument('--video_dataset_root', type=str,default="dataset/VPS-TrainSet/")
