...
if __name__=="__main__":
    ...
    img=Image.open("/home/guyuchao/ssd/PycharmProjects/videofastsal/checkpoints/tensorboard/store/baseline/epoch_1_batch_0/DAVIS/blackswan/pred/blackswan_00000.png")
    print(img.size)